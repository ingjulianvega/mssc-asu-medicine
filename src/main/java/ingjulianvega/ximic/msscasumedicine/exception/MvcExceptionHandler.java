...
import ingjulianvega.ximic.msscasumedicine.configuration.MedicineParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(MedicineParameters medicineParameters) {
        this.medicineParameters = medicineParameters;
    }

    MedicineParameters medicineParameters;


    @ExceptionHandler(MedicineException.class)
    public ResponseEntity<ApiError> validationErrorHandler(MedicineException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(medicineParameters.getApi())
